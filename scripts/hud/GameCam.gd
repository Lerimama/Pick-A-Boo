...
# ui
onready var trauma_time_slider: HSlider = $TestUI/TestHud/TraumaControl/TraumaTime
onready var trauma_strength_slider: HSlider = $TestUI/TestHud/TraumaControl/TraumaStrength
onready var decay_slider: HSlider = $TestUI/TestHud/TraumaControl/ShakeDecay

onready var trauma_bar = $TestUI/TestHud/TraumaBar
onready var shake_bar = $TestUI/TestHud/ShakeBar
onready var trauma_btn = $TestUI/TestHud/AddTraumaBtn

onready var zoom_slider = $TestUI/TestHud/ZoomSlider
onready var time_slider = $TestUI/TestHud/TimeSlider
onready var reset_view_btn = $TestUI/TestHud/ResetViewBtn

onready var seed_slider = $TestUI/TestHud/NoiseControl/Seed
onready var octaves_slider = $TestUI/TestHud/NoiseControl/Octaves
onready var period_slider = $TestUI/TestHud/NoiseControl/Period
onready var persistence_slider = $TestUI/TestHud/NoiseControl/Persistence
onready var lacunarity_slider = $TestUI/TestHud/NoiseControl/Lacunarity

onready var testhud_node = $TestUI/TestHud
onready var test_toggle_btn = $TestUI/TestToggle


func _ready():

	Glo.main_camera = self
	Glo.camera_target = null # da se nulira (pri quit game) in je naslednji play brez errorja ... seta se ob spawnanju plejerja
...
#		position = camera_target.position
	if Glo.camera_target:
		position = Glo.camera_target.position
...
func reset_camera_position():
	...
	# position = Glo.level_start_position.global_position
